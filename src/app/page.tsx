...
import { 
  CheckCircle2, Phone, Mail, FileText, MessageSquare, 
  ClipboardList, UserCircle, ImageIcon, Paperclip, Link2, X, 
  Upload, File, Building2
} from 'lucide-react'
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-center">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="text-center sm:text-left">
              <h1 className="text-base sm:text-xl font-bold leading-tight">DOST - PCIEERD</h1>
              <p className="text-[10px] sm:text-sm text-sky-100">Concern Form</p>
            </div>
          </div>
        </div>
      </header>
